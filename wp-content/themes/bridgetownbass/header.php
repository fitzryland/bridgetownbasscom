...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html class="no-js" lang="en"><!--<![endif]-->
	...
	<body <?php body_class(); ?>>
		...
		<div class="fixed"></div>
		<header>
			<img src="<?php echo get_template_directory_uri(); ?>/images/btbheaderlogo3_2.png" width="498" height="447" alt="Btbheaderlogo2" class="logo">
			<img src="<?php echo get_template_directory_uri(); ?>/images/btbheaderlogo3_2mobile.png" width="316" height="284" alt="BRIDGETOWN BASS" class="logomobile">
			<h1>
